...
```{r repo-link, results='asis', echo=FALSE, comment=NA}
knitr::asis_output("\\begin{center}\\footnotesize Repository: \\url{https://github.com/kshoker12/STAT_405_Project}\\end{center}\n")
```
...
**Note:** For variational inference we used mean field in stan thus our variational family was $\mathscr{Q}= \{q_\phi : \phi \in \Phi\}$.
