// ============================================================================
// Naive (Level-1 skill) IRT model with:
...
//
// This model is identical in structure to bayesian_model/main.stan but is
// trained on K=9 broad Level-1 skills (Number, Algebra, Geometry, etc.)
// rather than the K=69 fine-grained Level-2 skills used in the primary model.
// ============================================================================
